<%@ Page Title="" Language="C#" MasterPageFile="~/Landing.master" AutoEventWireup="true" CodeFile="Home.aspx.cs" Inherits="Home" %>
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <div>
                 ...
                 This salad is a staple in Greek cuisine and is celebrated for its simplicity, highlighting the natural flavors of fresh, high-quality ingredients.
                  </p>
...
Lasagne, a classic Italian dish, is a culinary masterpiece that has gained international acclaim for its layers of pasta, rich meat or vegetable sauce, creamy béchamel, and melted cheese.
                  </p>
...
Butternut pumpkin, also known as butternut squash, is a popular and versatile vegetable that belongs to the gourd family, Cucurbitaceae.
                  </p>
    ...
    ForeColor="Red" Font-Bold="False" Font-Size="Smaller" />
            ...
            <asp:TextBox ID="txtMessagetbl" runat="server" placeholder="Message" CssClass="input-field" TextMode="MultiLine" Rows="4"></asp:TextBox>
              <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtMessagetbl"
               ...
               <a class="btn btn-secondary"  href="#" onclick="showLoginRequiredMessage();"><i></i>SUBMIT</a>
            ...
            <section>
                <div>
                    ...
                    ErrorMessage="Message required" Display="Dynamic" Font-Bold="False" Font-Size="Smaller" ForeColor="Red"></asp:RequiredFieldValidator>
                                 ...
                                 <a class="btn btn-secondary"  href="#" onclick="showLoginRequiredMessage();"><i></i><center>SEND</center></a>
                            </asp:Panel>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
